...
public class FilesActivity extends BaseActivity {
    ...
    public void loadData() {
        ...
        new ListFolderTask(DropboxApiFragment.getClient(), new ListFolderTask.Callback() {
            @Override
    ...
    private void downloadFile(FileMetadata file) {
        ...
        new DownloadFileTask(this, DropboxApiFragment.getClient(), new DownloadFileTask.Callback() {
            @Override
    ...
    private void uploadFile(String fileUri) {
        ...
        new UploadFileTask(this, DropboxApiFragment.getClient(), new UploadFileTask.Callback() {
            @Override
