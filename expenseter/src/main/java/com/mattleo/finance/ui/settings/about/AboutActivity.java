package com.mattleo.finance.ui.settings.about;
...
public class AboutActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showChangeLog() {
        openUrl("https://github.com/mvarnagiris/Expenseter-public/blob/dev/CHANGELOG.md");
    }

    private void showIssues() {
        openUrl("https://github.com/mvarnagiris/Expenseter-public/blob/dev/README.md");
    }

    private void showRate() {
        openUrl("https://play.google.com/store/apps/details?id=com.mattleo.finance");
    }
    ...
    private void showTranslate() {
        openUrl("https://crowdin.com/project/expenseter");
    }
