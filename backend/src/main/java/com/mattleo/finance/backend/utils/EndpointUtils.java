package com.mattleo.finance.backend.utils;

import com.mattleo.finance.backend.endpoint.body.Body;
...
public class EndpointUtils {
    ...
    public static void notifyOtherDevices(UserAccount userAccount, String senderDeviceRedId) throws IOException {
        ...
        final List<DeviceEntity> devices = OfyService.ofy()
                .load()
        ...
        for (DeviceEntity device : devices) {
            ...
            if (result.getMessageId() != null) {
                ...
                if (error.equals(Constants.ERROR_NOT_REGISTERED)) {
                    ...
                    OfyService.ofy().delete().entity(device).now();
                }
            }
        }
    }
